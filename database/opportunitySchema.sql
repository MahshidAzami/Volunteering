...
with disinfectant spray. Sweep and mop the floors and wash all of the windows.", "https:
//cleanmyspace.com/wp-content/uploads/2017/08/how-to-hire-a-cleaning-service.jpg");

insert into opportunities
    (title, time_frame, duty, pic)
VALUES
    ("Computer" , "Sunday 9:30 a.m - 12:30 p.m", "The same as any other business or organization would
use computing for publishing, storage info, organizing info, doing bookkeeping, searching information, communications etc.", "https:
...
ministry requires people's hearts be prepared through teaching.", "http:
//www.buncombestreetumc.org/wp-content/uploads/2018/06/Prayer-1-of-1.jpg");
...
insert into opportunities
    (title, time_frame, duty, pic)
VALUES
    ("Translation" , "Sunday 10:30 a.m - 12 p.m", "there are peaple from 21 different nationalities in our church. most of them speak English but we always need people who can translate from English to Persian and Kurdish.", "https:
//farm1.static.flickr.com/685/22054913750_c5b11f7e59_b.jpg");
